...
import scala.scalajs.sbtplugin.environment.Console
import scala.scalajs.sbtplugin.environment.LoggerConsole
import scala.scalajs.sbtplugin.environment.RhinoBasedScalaJSEnvironment
